            ...
            <div className="card-luxury p-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-6 border border-accent/30 text-center">
                  ...
                  <p dir="ltr" className="heading-hero text-3xl text-accent tabular-nums text-center [text-align-last:center]">{formatPct(grossROIValue)}</p>
                </div>
                <div className="p-6 border border-accent/30 text-center">
                  <p className="text-xs text-muted-foreground uppercase tracking-wider mb-2">{t("invest.netROI")}</p>
                  <p dir="ltr" className="heading-hero text-3xl text-accent tabular-nums text-center [text-align-last:center]">{formatPct(netROIValue)}</p>
