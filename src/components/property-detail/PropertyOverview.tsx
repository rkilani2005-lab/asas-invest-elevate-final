...
import { localizeUnitTypes, localizeOwnership, localizeSizeRange } from "@/lib/unit-types";
...
const PropertyOverview = ({ property }: PropertyOverviewProps) => {
  ...
  const specs = [
    ...
    { icon: Maximize2, label: t("property.sizeRange"), value: property.size_range ? <span dir="ltr" className="inline-block">{localizeSizeRange(property.size_range, language)}</span> : null },
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className={cn(
          ...
          <div className={cn("lg:col-span-2")}>
            ...
            {highlights.length > 0 && (
              <div className="mt-8">
                <h3 className={cn("text-accent text-xs font-medium tracking-widest uppercase mb-4")}>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-accent/30 p-6 sticky top-40 shadow-card">
              <h3 className={cn("text-accent text-xs font-medium tracking-widest uppercase mb-6")}>
